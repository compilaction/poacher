...
constexpr auto tokenize_ident
   = tokenize_str_gen( poacher::ct_string("ident"), tokens::grp_lpar{} );

constexpr auto tokenize_open_paren
   = tokenize_char_gen( '(', tokens::grp_lpar{} );
constexpr auto tokenize_close_paren
   = tokenize_char_gen( ')', tokens::grp_rpar{} );
constexpr auto tokenize_op_mul
   = tokenize_char_gen( '*', tokens::op_times{} );
constexpr auto tokenize_op_div
   = tokenize_char_gen( '/', tokens::op_div{} );
constexpr auto tokenize_op_add
   = tokenize_char_gen( '+', tokens::op_add{} );
constexpr auto tokenize_op_sub
   = tokenize_char_gen( '-', tokens::op_sub{} );
