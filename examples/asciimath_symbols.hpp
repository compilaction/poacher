...
using token_type_list = poacher::token_type_list
   ...
   //o , tokens::misc_int
   //o , tokens::misc_oint
   //o , tokens::misc_partial
   //o , tokens::misc_nabla
   //o , tokens::misc_pm
   //o , tokens::misc_emptyset
   //o , tokens::misc_infty
   //o , tokens::misc_aleph
   //o , tokens::misc_therefore
   //o , tokens::misc_because
   //o , tokens::misc_ldots
   //o , tokens::misc_cdots
   //o , tokens::misc_vdots
   //o , tokens::misc_ddots
   //o , tokens::misc_smallquad
   //o , tokens::misc_quad
   //o , tokens::misc_angle
   //o , tokens::misc_frown
   //o , tokens::misc_triangle
   //o , tokens::misc_diamond
   //o , tokens::misc_square
   //o , tokens::misc_lfloor
   //o , tokens::misc_rfloor
   //o , tokens::misc_lceiling
   //o , tokens::misc_rceiling
   //o , tokens::misc_C
   //o , tokens::misc_N
   //o , tokens::misc_Q
   //o , tokens::misc_R
   ...
   //o , tokens::grp_langle
   //o , tokens::grp_rangle
   //o , tokens::grp_langle_
   //o , tokens::grp_rangle_
   //o , tokens::grp_lxpar
   //o , tokens::grp_rxpar
   //o , tokens::grp_abs
   //o , tokens::grp_floor
